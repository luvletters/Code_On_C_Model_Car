...
{
	TIM_SetCompare1(TIM_SERVO,1600);
	TIM_SetCompare2(TIM_SERVO,1600);
	TIM_SetCompare3(TIM_SERVO,1600);
	delay_ms(1000);
	TIM_SetCompare1(TIM_SERVO,1300);
	TIM_SetCompare2(TIM_SERVO,1300);
	TIM_SetCompare3(TIM_SERVO,1300);
